...
public class GeoUtil {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10000; i++) {
			...
			int drawBresenhamLine = drawBresenhamLineAL(x1, y1, x2, y2).size();
			// int drawBresenhamLine = drawBresenhamLine(x1, y1, x2, y2).size();
			int distaciaEntrePontos = distaciaEntrePontos(x1, y1, x2, y2);
			// System.out.println("drawBresenhamLine " + drawBresenhamLine
			// + "  distaciaEntrePontos " + distaciaEntrePontos);
		}
