...
public class OcilaCor {
	...
	public static BufferedImage geraOcila(String chave, BufferedImage src) {
		Color geraOcila = geraOcila(chave, Color.WHITE);
		return ImageUtil.gerarFade(src, geraOcila.getAlpha());
	}
